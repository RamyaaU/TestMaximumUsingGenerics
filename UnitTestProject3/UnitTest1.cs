...
namespace UnitTestProject3
{
    ...
    public class UnitTest1
    {
        ...
        ///TC 3.1
        /// <summary>
        /// Given the string maximum value at first position return maximum.
        /// </summary>
        /// <param name="firstValue">The first value.</param>
        /// <param name="secondValue">The second value.</param>
        /// <param name="thirdValue">The third value.</param>
        ...
        [DataRow("Papaya", "Apricot", "Berry")]
        public void Given_String_Max_value_At_First_Position_Return_Max(string firstValue, string secondValue, string thirdValue)
        {
            //Arrange
            string expected = firstValue;
            //Act
            string result = MaximumNumberCheck.MaximumStringValue(firstValue, secondValue, thirdValue);
            //Assert
            Assert.AreEqual(expected, result);
        }
        ...
        /// TC 3.2
        /// <summary>
        /// Givens the string maximum value at second position return maximum.
        /// </summary>
        /// <param name="firstValue">The first value.</param>
        /// <param name="secondValue">The second value.</param>
        /// <param name="thirdValue">The third value.</param>
        [TestMethod]
        [DataRow("Banana", "Peach", "Apple")]
        [DataRow("Apricot", "Papaya", "Berry")]
        public void Given_String_Max_value_At_Second_Position_Return_Max(string firstValue, string secondValue, string thirdValue)
        {
            //Arrange
        ...
        /// TC 3.3
        /// <summary>
        /// Givens the string maximum value at third position return maximum.
        /// </summary>
        /// <param name="firstValue">The first value.</param>
        /// <param name="secondValue">The second value.</param>
        /// <param name="thirdValue">The third value.</param>
